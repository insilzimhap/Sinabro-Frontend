...
/*
 * 파일: lib/main/parentView/page/child_profile_edit.dart
 * 개요: 부모가 자녀 프로필을 확인·수정·삭제하는 화면.
 *      이름/닉네임/생일/학습 제한시간 편집, 선택적 비밀번호 변경(유효성 포함),
 *      자녀 삭제 플로우(부모 비밀번호 확인 → 재확인) 제공.
 *      ParentLayout 내부의 스크롤 가능한 폼으로 구성되며,
 *      현재는 데모 데이터 기반으로 동작(서버 연동 지점: _save / _deleteFlow).
 */

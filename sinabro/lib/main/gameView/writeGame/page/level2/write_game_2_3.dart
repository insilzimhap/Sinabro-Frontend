// lib/main/studyView/writeGame/page/level2/write_game_2_3.dart
import 'dart:math';
...
const List<_Item> _CONSONANTS = [
  ...
  _Item(
    ...
    char: 'ㄲ',
    nameKo: '쌍기역',
    audio: '${_CONS_AUD}ssang_giyeok.mp3',
    type: _TargetType.consonant,
  ),
  _Item(
    key: 'digeut',
  ...
  _Item(
    ...
    char: 'ㄸ',
    nameKo: '쌍디귿',
    audio: '${_CONS_AUD}ssang_digeut.mp3',
    type: _TargetType.consonant,
  ),
  _Item(
    key: 'siot',
  ...
  _Item(
    ...
    char: 'ㅆ',
    nameKo: '쌍시옷',
    audio: '${_CONS_AUD}ssang_siot.mp3',
    type: _TargetType.consonant,
  ),
  _Item(
    key: 'jieut',
  ...
  _Item(
    ...
    char: 'ㅉ',
    nameKo: '쌍지읒',
    audio: '${_CONS_AUD}ssang_jieut.mp3',
    type: _TargetType.consonant,
  ),
  _Item(
    key: 'bieup',
  ...
  _Item(
    ...
    char: 'ㅃ',
    nameKo: '쌍비읍',
    audio: '${_CONS_AUD}ssang_bieup.mp3',
    type: _TargetType.consonant,
  ),
  _Item(
    key: 'nieun',
...
class WriteGameLevel2_3Page extends StatefulWidget {
  const WriteGameLevel2_3Page({super.key, required this.childId});
...
class _BalloonPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final r = RRect.fromRectAndRadius(
      Rect.fromLTWH(0, 0, size.width, size.height - 10), // 하단 10px 꼬리 공간
      const Radius.circular(12),
    );
    final paint = Paint()..color = const Color(0xFFF2E2CF);
    canvas.drawRRect(r, paint);

    const double tailBaseX = 40; // 꼬리 가로 위치

...
class PigRevealPage extends StatefulWidget {
  const PigRevealPage({super.key});

  static const routeName = '/listen/animals/pig-reveal';

  @override
  State<PigRevealPage> createState() => _PigRevealPageState();
}

class _PigRevealPageState extends State<PigRevealPage> {
  ...
  Future<void> _playAndNavigate() async {
    try {
      ...
      debugPrint('PigReveal audio error: $e');
    }
    ...
    _playerSub = _player.playerStateStream.listen((s) async {
      if (s.processingState == ProcessingState.completed) {
        ...
        if (!mounted) return;
        Navigator.pushReplacementNamed(context, PigStoryPage.routeName);
      }
    });
  }
          ...
          return Stack(
            children: [
              ...
              Positioned(
                ...
                height: u.sw(857),
                child: Image.asset(
                  'assets/img/contents/studyListen/level1/animals/pig_00.png',
                  fit: BoxFit.cover,
                ),
              ),

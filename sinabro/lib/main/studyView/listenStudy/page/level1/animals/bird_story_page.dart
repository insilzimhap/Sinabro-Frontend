...
class BirdStoryPage extends StatefulWidget {
  const BirdStoryPage({
    super.key,
    this.onFinished,
  });
  ...
  static const routeName = '/listen/animals/bird-story';

  /// 마지막 장면 이후 이어서 갈 화면이 있다면 콜백으로 연결
  final VoidCallback? onFinished;

  @override
  State<BirdStoryPage> createState() => _BirdStoryPageState();
}

class _BirdStoryPageState extends State<BirdStoryPage> {
  ...
  Future<void> _playCurrent() async {
    ...
    try {
      ...
      debugPrint('BirdStory audio error: $e');
    }
  ...
  void _goToOutro() {
    Navigator.of(context).pushReplacement(PageRouteBuilder(
      ...
      pageBuilder: (_, __, ___) => const BirdOutroPage(),

...
class ElephantRevealPage extends StatefulWidget {
  const ElephantRevealPage({super.key});

  static const routeName = '/listen/animals/elephant-reveal';

  @override
  State<ElephantRevealPage> createState() => _ElephantRevealPageState();
}

class _ElephantRevealPageState extends State<ElephantRevealPage> {
  ...
  Future<void> _playAndNavigate() async {
    try {
      ...
      debugPrint('ElephantReveal audio error: $e');
    }
    ...
    _playerSub = _player.playerStateStream.listen((s) async {
      if (s.processingState == ProcessingState.completed) {
        ...
        if (!mounted) return;
        Navigator.pushReplacementNamed(context, ElephantStoryPage.routeName);
      }
    });
  }

...
class CatRevealPage extends StatefulWidget {
  const CatRevealPage({super.key});

  static const routeName = '/listen/animals/cat-reveal';

  @override
  State<CatRevealPage> createState() => _CatRevealPageState();
}

class _CatRevealPageState extends State<CatRevealPage> {
  ...
  Future<void> _playAndNavigate() async {
    try {
      ...
      debugPrint('CatReveal audio error: $e');
    }
    ...
    _playerSub = _player.playerStateStream.listen((s) async {
      if (s.processingState == ProcessingState.completed) {
        ...
        if (!mounted) return;
        Navigator.pushReplacementNamed(context, CatStoryPage.routeName);
      }
    });
  }
          ...
          return Stack(
            children: [
              ...
              Positioned(
                ...
                height: u.sw(828),
                child: Image.asset(
                  'assets/img/contents/studyListen/level1/animals/cat_00.png',
                  fit: BoxFit.cover,
                ),
              ),

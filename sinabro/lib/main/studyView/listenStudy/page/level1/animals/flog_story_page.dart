...
class FlogStoryPage extends StatefulWidget {
  const FlogStoryPage({
    super.key,
    this.onFinished,
  });
  ...
  static const routeName = '/listen/animals/flog-story';

  /// 마지막 장면 이후 이어서 갈 화면이 있다면 콜백으로 연결
  final VoidCallback? onFinished;

  @override
  State<FlogStoryPage> createState() => _FlogStoryPageState();
}

class _FlogStoryPageState extends State<FlogStoryPage> {
  ...
  Future<void> _playCurrent() async {
    ...
    try {
      ...
      debugPrint('FlogStory audio error: $e');
    }
  ...
  void _goToOutro() {
    Navigator.of(context).pushReplacement(PageRouteBuilder(
      ...
      pageBuilder: (_, __, ___) => const FlogOutroPage(),

...
class PenguinRevealPage extends StatefulWidget {
  const PenguinRevealPage({super.key});

  static const routeName = '/listen/animals/penguin-reveal';

  @override
  State<PenguinRevealPage> createState() => _PenguinRevealPageState();
}

class _PenguinRevealPageState extends State<PenguinRevealPage> {
  ...
  Future<void> _playAndNavigate() async {
    try {
      ...
      debugPrint('PenguinReveal audio error: $e');
    }
    ...
    _playerSub = _player.playerStateStream.listen((s) async {
      if (s.processingState == ProcessingState.completed) {
        ...
        if (!mounted) return;
        Navigator.pushReplacementNamed(context, PenguinStoryPage.routeName);
      }
    });
  }

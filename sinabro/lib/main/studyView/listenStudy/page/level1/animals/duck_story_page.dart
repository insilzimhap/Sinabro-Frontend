...
class DuckStoryPage extends StatefulWidget {
  const DuckStoryPage({
    super.key,
    this.onFinished,
  });
  ...
  static const routeName = '/listen/animals/duck-story';

  /// 마지막 장면 이후 이어서 갈 화면이 있다면 콜백으로 연결
  final VoidCallback? onFinished;

  @override
  State<DuckStoryPage> createState() => _DuckStoryPageState();
}

class _DuckStoryPageState extends State<DuckStoryPage> {
  ...
  Future<void> _playCurrent() async {
    ...
    try {
      ...
      debugPrint('duckStory audio error: $e');
    }
  ...
  void _goToOutro() {
    Navigator.of(context).pushReplacement(PageRouteBuilder(
      ...
      pageBuilder: (_, __, ___) => const DuckOutroPage(),

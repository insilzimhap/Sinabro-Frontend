...
class DogStoryPage extends StatefulWidget {
  const DogStoryPage({
    super.key,
    this.onFinished,
  });
  ...
  static const routeName = '/listen/animals/dog-story';

  /// 마지막 장면 이후 이어서 갈 화면이 있다면 콜백으로 연결
  final VoidCallback? onFinished;

  @override
  State<DogStoryPage> createState() => _DogStoryPageState();
}

class _DogStoryPageState extends State<DogStoryPage> {
  ...
  Future<void> _playCurrent() async {
    ...
    try {
      ...
      debugPrint('DogStory audio error: $e');
    }
  ...
  void _goToOutro() {
    Navigator.of(context).pushReplacement(PageRouteBuilder(
      ...
      pageBuilder: (_, __, ___) => const DogOutroPage(),

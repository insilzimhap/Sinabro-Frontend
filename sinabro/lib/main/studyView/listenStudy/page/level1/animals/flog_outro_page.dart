// lib/main/studyView/listenStudy/animals/flog_outro_page.dart
//
// 마지막 동물(개구리) 엔딩 + 전체 완료 화면을 한 파일에서 순차 진행
// Step 0) 개구리 엔딩 (배경: flog_06.png, 말풍선 텍스트1, 오디오: flog06.mp3)
...
class FlogOutroPage extends StatefulWidget {
  const FlogOutroPage({
    super.key,
    this.onFinished,
  });

  static const routeName = '/listen/animals/flog-outro';

  /// 전 구간 재생 완료 후 호출(예: 사과 팝업 띄우기, 트리 화면 복귀 등)
  final VoidCallback? onFinished;

  @override
  State<FlogOutroPage> createState() => _FlogOutroPageState();
}

class _FlogOutroPageState extends State<FlogOutroPage> {
  ...
  static const String _frogBg =
      'assets/img/contents/studyListen/level1/animals/flog_06.png';
  static const String _frogLine = '개구리는 수영하러 폴짝폴짝 뛰어갔어요!';
  static const String _frogAudio =
      'assets/audio/tts/studyListen/level1/animals/flog06.mp3';
  ...
  static const String _finalLine = '집 주변에서 만날 수 있는\n동물 친구들을 모두 만났어요!';
  ...
  Future<void> _playCurrent() async {
    ...
    try {
      ...
      debugPrint('FlogOutro audio error($_step): $e');
      // 오디오 실패해도 UX 흐름은 보장

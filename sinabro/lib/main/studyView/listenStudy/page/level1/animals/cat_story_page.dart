...
class CatStoryPage extends StatefulWidget {
  const CatStoryPage({
    super.key,
    this.onFinished,
  });
  ...
  static const routeName = '/listen/animals/cat-story';

  /// 마지막 장면 이후 이어서 갈 화면이 있다면 콜백으로 연결
  final VoidCallback? onFinished;

  @override
  State<CatStoryPage> createState() => _CatStoryPageState();
}

class _CatStoryPageState extends State<CatStoryPage> {
  ...
  Future<void> _playCurrent() async {
    ...
    try {
      ...
      debugPrint('CatStory audio error: $e');
    }
  ...
  void _goToOutro() {
    Navigator.of(context).pushReplacement(PageRouteBuilder(
      ...
      pageBuilder: (_, __, ___) => const CatOutroPage(),

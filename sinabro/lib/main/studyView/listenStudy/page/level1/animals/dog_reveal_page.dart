...
class DogRevealPage extends StatefulWidget {
  const DogRevealPage({super.key});

  static const routeName = '/listen/animals/dog-reveal';

  @override
  State<DogRevealPage> createState() => _DogRevealPageState();
}

class _DogRevealPageState extends State<DogRevealPage> {
  ...
  Future<void> _playAndNavigate() async {
    try {
      ...
      debugPrint('DogReveal audio error: $e');
    }
    ...
    _playerSub = _player.playerStateStream.listen((s) async {
      if (s.processingState == ProcessingState.completed) {
        ...
        if (!mounted) return;
        Navigator.pushReplacementNamed(context, DogStoryPage.routeName);
      }
    });
  }
          ...
          return Stack(
            children: [
              ...
              Positioned(
                ...
                height: u.sw(828),
                child: Image.asset(
                  'assets/img/contents/studyListen/level1/animals/dog_00.png',
                  fit: BoxFit.cover,
                ),
              ),

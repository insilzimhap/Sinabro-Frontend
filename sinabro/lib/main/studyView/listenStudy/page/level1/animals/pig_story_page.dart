...
class PigStoryPage extends StatefulWidget {
  const PigStoryPage({
    super.key,
    this.onFinished,
  });
  ...
  static const routeName = '/listen/animals/pig-story';

  /// 마지막 장면 이후 이어서 갈 화면이 있다면 콜백으로 연결
  final VoidCallback? onFinished;

  @override
  State<PigStoryPage> createState() => _PigStoryPageState();
}

class _PigStoryPageState extends State<PigStoryPage> {
  ...
  Future<void> _playCurrent() async {
    ...
    try {
      ...
      debugPrint('PigStory audio error: $e');
    }
  ...
  void _goToOutro() {
    Navigator.of(context).pushReplacement(PageRouteBuilder(
      ...
      pageBuilder: (_, __, ___) => const PigOutroPage(),
